...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zdesk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12002&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zdesk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zdesk` can be installed with:

```
conda install zdesk
```

It is possible to list all of the versions of `zdesk` available on your platform with:
